...
export default function Header() {
    ...
    const changeLang = (e: { value: string; label: string } | null) => {
        if (!e) return;
                    ...
                    <div className="header__inner">
                        ...
                        <div className="header__wallet">
                            <Link to="/wallet">
                                ...
                                <span className="wallet__ton">{user?.ton?.toFixed(5) ?? 0}</span> To
                            </Link>
                        </div>
                        <div className="header__wallet ml">
                            <Link to="/wallet">
                                ...
                                <span className="tap__wallet-amout">{user?.coins?.toFixed(5) ?? 0}</span> GC
                            </Link>
                        </div>
            ...
            <nav className="navigation__wrapper mobile">
                <div className="container">
                    <ul className="nav__inner">
                        <li className={'nav__item' + ' ' + isActive('/planets')}>
                            <Link to="/planets">
                                <img src="/img/mobile/planet.svg" />
                                {t('home')}
                            </Link>
                        </li>
                        <li className={'nav__item' + ' ' + isActive('/market')}>
                            <Link to="/market">
                                <img src="/img/mobile/exchange.svg" /> 
                                {t('market')}
                            </Link>
                        </li>
                        <li className={'nav__item' + ' ' + isActive('/wallet')}>
                            <Link to="/wallet">
                              <img src='/img/mobile/wallet.svg' />
                              {t('wallet')}
                            </Link>
                        </li>
                        <li className={'nav__item' + ' ' + isActive('/laboratory')}>
                            <Link to="/laboratory">
                              <img src='/img/mobile/laboratory.svg' />
                              {t('laboratory')}
                            </Link>
                        </li>
                        <li className={'nav__item' + ' ' + isActive('/tasks')}>
                            <Link to="/tasks">
                              <img src='/img/mobile/tasks.svg' />
                              {t('tasks')}
                            </Link>
                        </li>
                    </ul>
