export default class BorderAnimation {
    ...
    init() {
        ...
        // Добавляем класс для анимации подъема
    ...
    updatePath() {
        ...
        const strokeWidth = 2;  // Ширина границы
...
// Инициализация с отложенной установкой
setTimeout(() => {
    document.querySelectorAll('.animated-border-container').forEach(element => {
